...
function BP_WeaponBase_C:GetFireInfo()
    local BPI_Interfaces_C = UE.UClass.Load("/Game/BPI_Interfaces.BPI_Interfaces_C")
    local TraceStart, TraceDirection = BPI_Interfaces_C.GetWeaponTraceInfo(self.Instigator)
